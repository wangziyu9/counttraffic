...
import numpy as np
import skvideo
skvideo.setFFmpegPath(r'C:\Users\yur\exe\ffmpeg-20200312-675bb1f-win64-static\bin')
import skvideo.io
import cv2
...
# ============================================================================
IMAGE_DIR = "./out"
VIDEO_SOURCE = "京沪高速大车流监控实拍-720.mp4"

SHAPE = (720, 1280)  # HxW
EXIT_PTS = np.array([
    [[720, 480], [720, 0], [1280, 0], [1280, 480]],
    [[0, 720], [720, 720], [720, 680], [0, 680]]
])
...
# SHAPE = (272, 480)  # HxW
# EXIT_PTS = np.array([
#     [[270, 272], [270, 0], [480, 0], [480, 272]],
#     [[0, 180], [270, 180], [270, 0], [0, 0]]
# ])
# ============================================================================
