...
class VehicleCounter(PipelineProcessor):
    ...
    def __init__(self, exit_masks=[], path_size=3, max_dst=30, x_weight=1.0, y_weight=1.0):
...
class Visualizer(PipelineProcessor):
    ...
    def draw_ui(self, img, vehicle_count, exit_masks=[]):
        ...
        cv2.putText(img, ("Vehiclespassed: {total} ".format(total=vehicle_count)), (30, 30),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 1)
        zh_word_img = cv2.imread('zh_word.png')
        img[0:50,0:200] = zh_word_img
        return img
